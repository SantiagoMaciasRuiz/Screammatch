...
public class Titulo implements Comparable<Titulo>{
    ...
    public Titulo(TituloOmdb miTituloOmdb) {
        ...
        if (miTituloOmdb.runtime().contains("N/A")) {
            throw new ErrorEnCoversionDeDuracionException("No pude convertir la duracion, por que contiene un N/A");
    ...
    public void muestraFichaTecnica(){
        ...
        System.out.println("La duración de la pelicula es:" + getDuracionEnMinutos());
    }
